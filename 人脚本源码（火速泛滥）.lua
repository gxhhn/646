...
local Window = OrionLib:MakeWindow({Name = "『人脚本』", HidePremium = false, SaveConfig = true,IntroText = "『人脚本』", ConfigFolder = "『人脚本』"})

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "人脚本"; Text ="吉吉国王"; Duration = 4; })
